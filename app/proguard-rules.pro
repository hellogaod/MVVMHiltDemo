...
#------------------------------------------主项目混淆规则----------------------------------------------
#实体类不参与混淆
-keep class com.aregyan.data.database.** { *; }
-keep class com.aregyan.data.domain.** { *; }
-keep class com.aregyan.data.network.model.** { *; }
...
-keep class com.aregyan.data.network.model.BaseResponse { *; }
...
#---------------------------------4.反射相关的类和方法-----------------------
-keep public class * extends com.aregyan.github.views.base.BaseActivity{ *; }
-keep public class * extends com.aregyan.github.views.base.BaseFragment{ *; }
