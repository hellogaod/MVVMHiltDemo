...
public abstract class BasePagerFragment extends BaseFragment {
    ...
    @Override
    protected ViewDataBinding initAndGetViewDataBinding(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        return null;
    }

    @Override
    protected BaseViewModel initBaseViewModel() {
        return null;
    }
